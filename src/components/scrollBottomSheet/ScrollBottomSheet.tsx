...
export class ScrollBottomSheet extends Component<ScrollBottomSheetProps> {
  static defaultProps = {
    topInset: 0,
  };
  /**
  ...
  private innerRef = React.createRef<FlatList | ScrollView | SectionList>();
  ...
  constructor(props: ScrollBottomSheetProps) {
    super(props);
      ...
      >
        ...
        >
          <Animated.View style={styles.container}>
            <ScrollBottomSheetContext.Provider
              value={{
            ...
            cond(this.didGestureFinish, [
              ...
              cond(
                ...
                call([], () => {
                  /**
                   * @DEV
                   * here we get the component name out of the innerRef
                   */
                  const componentType: keyof typeof imperativeScrollOptions =
                    // @ts-ignore
                    this.innerRef.current?._component?.constructor.name ?? null;
                  ...
                  // @ts-ignore
                  this.innerRef.current?.getNode()[method](args);
                })
              ),
              set(this.dragY, 0),
